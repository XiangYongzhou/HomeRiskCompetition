# https://www.kaggle.com/oysiyl/good-fun-with-ligthgbm
# Based on  awesome script (https://www.kaggle.com/ogrellier/good-fun-with-ligthgbm)
# and parameters (https://www.kaggle.com/tilii7/olivier-lightgbm-parameters-by-bayesian-opt)
#you can try use my version of the so lib or install lgbm using this https://github.com/Microsoft/LightGBM/blob/master/docs/Installation-Guide.rstls
